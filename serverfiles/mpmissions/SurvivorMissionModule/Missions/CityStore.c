...
{	//CityStore is a copy of UrbanMall mission, it uses another secondary mission building
	...
	{		
		...
		m_MissionMessage2 = "昨天我得知，位于\n** " + m_MissionLocationDir + " 的 " + m_MissionLocation + " **\n的城市商店被封锁了，里面可能还有食物。但周围感染者太多，我没法进去查看。";
		m_MissionMessage3 = "她急需以下物资：\n- " + ReqFoodAmount + " 罐食物\n- " + ReqMedAmount + " 包抗生素\n请帮我把这些必需品送给 " + SurvivorName + " 女士，用来照顾孩子们。小心！";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage2 = "我觉得最好的办法是把补给放到小\n** "+ m_MissionSecondaryLoc +" ** 警局的安静室里，全部装进我放在那里的橙色背包。我会在一小时后去查看，并尝试用无线电联系她。";
